...
document.getElementById('BMRform').addEventListener('submit', function (e) {
   e.preventDefault();
   logUserAction("BMR Calculator Tool");
   const activeTab = document.querySelector('.active-tab');
   let heightCM;
   let weightKg;
   if (activeTab && activeTab.id === 'UStab') {
...
bmrOutput.textContent = formattedBMR + ' kJ/day';
 ...
 document.getElementById('UStab').addEventListener('click', function (e) {
	e.preventDefault();
	document.getElementById('UStab').classList.add('active');
	document.getElementById('Metrictab').classList.remove('active');
	document.getElementById('UStabform').style.display = 'block';
	document.getElementById('MetricUnitsform').style.display = 'none';
 });

 // Event listener for the Metric Unit tab
 document.getElementById('Metrictab').addEventListener('click', function (e) {
	e.preventDefault();
	document.getElementById('Metrictab').classList.add('active');
	document.getElementById('UStab').classList.remove('active');
	document.getElementById('UStabform').style.display = 'none';
	document.getElementById('MetricUnitsform').style.display = 'block';
 });